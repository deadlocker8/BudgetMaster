...
public class Strings
{
	...
	public static final String WARNING_SETTINGS_PASSWORD_EQUALS_EXISTING = "notification.settings.security.warning";
	...
	public static final String WARNING_EMPTY_MIGRATION_PORT = "warning.empty.migration.port";
