...
public class BackupDatabase_v11 implements BackupDatabase
{
	...
	// field can not be static, since static field won't be exported to JSON by GSON
	private final transient String INTRODUCED_IN_VERSION = "v2.17.0";

	private List<BackupCategory_v7> categories;
	private List<BackupAccount_v11> accounts;
	...
	public BackupDatabase_v11()
	{
		// for GSON
	}

	public BackupDatabase_v11(List<BackupCategory_v7> categories, List<BackupAccount_v11> accounts, List<BackupTransaction_v6> transactions, List<BackupTemplateGroup_v8> templateGroups, List<BackupTemplate_v8> templates, List<BackupChart_v5> charts, List<BackupImage_v5> images, List<BackupIcon_v8> icons, List<BackupTransactionNameKeyword_v9> transactionNameKeywords, List<BackupCsvImportSettings_v10> csvImportSettings)
	{
	...
	public List<BackupAccount_v11> getAccounts()
	{
		return accounts;
	}

	public void setAccounts(List<BackupAccount_v11> accounts)
	{
		this.accounts = accounts;
	}
	...
	public static BackupDatabase_v11 createFromInternalEntities(InternalDatabase database)
	{
		final BackupDatabase_v11 externalDatabase = new BackupDatabase_v11();
